...
const Footer = () => {
  return (
    <div class="mt-20">
      ...
      <div class="max-w-screen-xl px-4 pt-10 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-gray-700">Helpful Links</p>
        ...
        <div class="pt-6 mt-12 border-t border-gray-600">
